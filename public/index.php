...
$router->add('GET', '/List/incomes/json', fn() => (new ListController)->getIncomeListAsJson());
$router->add('GET', '/List/expenditures/json', fn() => (new ListController)->getExpenditureListAsJson());
$router->add('GET', '/categories/income/json', fn() => (new ListController)->getIncomeCategoriesAsJson());
$router->add('GET', '/categories/expenditure/json', fn() => (new ListController)->getExpenditureCategoriesAsJson());
